...
# Funkcja deszyfrowania AES
def odszyfruj_AES():
    if var.get() != "opcja 4":
        # Wyświetl komunikat ostrzegawczy, jeśli wybrana opcja nie jest szyfrowaniem AES
        window2 = Tk()
...
# Funkcja zapisująca wynik do pliku tekstowego
def zapis():
...
# Labelka i przyciski wyboru dla szyfrów
Label(window, text="Wybierz szyfr:", bg="light gray", fg="black", font=("Yu Gothic UI Light", 15)).place(x=280, y=15)
var = StringVar()
rb1 = Radiobutton(window, text="SHA-128", variable=var, value="opcja 1", font=("Yu Gothic UI Light", 15), height=1,
                  width=10, background="light gray", indicatoron=0).place(x=115, y=65)
rb2 = Radiobutton(window, text="SHA-256", variable=var, value="opcja 2", font=("Yu Gothic UI Light", 15), height=1,
                  width=10, background="light gray", indicatoron=0).place(x=230, y=65)
rb3 = Radiobutton(window, text="MD5", variable=var, value="opcja 3", font=("Yu Gothic UI Light", 15), height=1,
                  width=10, background="light gray", indicatoron=0).place(x=345, y=65)
rb4 = Radiobutton(window, text="AES-128", variable=var, value="opcja 4", font=("Yu Gothic UI Light", 15), height=1,
                  width=10, background="light gray", indicatoron=0).place(x=460, y=65)
...
przycisk1 = Button(window, text="Zaszyfruj", activebackground="dark gray", activeforeground="black",
                   font=("Yu Gothic UI Light", 15), command=szyfruj)
przycisk1.place(x=250, y=250)

# Przycisk do deszyfrowania (tylko dla AES)
przycisk2 = Button(window, text="Odszyfruj", activebackground="dark gray", activeforeground="black",
                   font=("Yu Gothic UI Light", 15), command=odszyfruj_AES)
...
# Przycisk do zapisywania wyniku do pliku
Button(window, text="Zapisz do pliku .txt", activebackground="dark gray", activeforeground="black",
       font=("Yu Gothic UI Light", 15), command=zapis).place(x=250, y=400)
